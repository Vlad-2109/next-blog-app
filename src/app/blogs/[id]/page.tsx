		...
		<>
			...
			<div className="mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10">
				...
				<p className="my-3">
					...
					control of your life and make meaningful changes that lead a more
					balanced and fulfilling lifestyle. Remember that it&apos;s okay to
					seek support and guidance from professionals or mentors along the way.
